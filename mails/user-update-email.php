...
<head>
  ...
  <title>CLER - Modification de votre adresse email</title>
              ...
              <table width="100%" style="text-align:left; margin:20px 0;" border="0" cellpadding="0" cellspacing="0">
                <tr style="margin:0;padding:0;">
                  <td style="background: #fff; padding:20px 30px 30px;">
                    ...
                    <p style="text-align:left; font-family: gotham,helvetica,arial,sans-serif; font-size:16px;line-height: 22px;">Ce message vous confirme que <strong>votre adresse de messagerie a bien été modifiée</strong> sur le site du CLER - Réseau pour la transition énergétique.</p>

                    <p style="color:#ff9933;text-align:left; font-family: gotham,helvetica,arial,sans-serif; font-size:14px;line-height: 22px;">Si vous n’avez pas effectué cette action, veuillez contacter rapidement l’administrateur du site à cette adresse : info@cler.org.</p>
                  </td>
                </tr>
              </table>
            '.$footer_mail.'
